...
$string['configreplytoname'] = 'When a forum post is mailed out, should it contain the user\'s name or should it contain the course short name when not using the user\'s email.';
...
$string['replytoname'] = 'Use name in reply';
